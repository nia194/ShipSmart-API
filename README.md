...
| `app/mcp_server.py` | Standalone MCP HTTP server exposing tools (`validate_address`, `get_quote_preview`) for MCP clients. |
...
registry over HTTP so that IDE assistants, Spring Boot, and other MCP
